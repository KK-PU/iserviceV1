...
<div class="row">
    ...
    <p><b><?=Yii::t('app','solution')?></b></p>
        ...
        ?>
				...
				<?php
						if($model->job_status == 'request' &&  $model->job_employee_id == Yii::$app->user->identity->id){

							echo Html::a('<i class="glyphicon glyphicon-edit"></i> '.Yii::t('app','edit_data'),
								['update-request','id'=>$model->id],
								['class'=>'btn btn-info']);
				...
				<div class='pull-right'>
					<?=Html::a('<i class="glyphicon glyphicon-print"></i> '.Yii::t('app','print'),
							['job/print','id'=>$model->id],
							['class'=>'btn btn-primary','target'=>'_blank'])?>

					<?=Html::a('<i class="glyphicon glyphicon-off"></i> '.Yii::t('app','close'),null,['class'=>'btn btn-default','data-dismiss'=>'modal']);?>
				</div>
